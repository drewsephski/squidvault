      ...
      <header className="w-full border-b border-border px-6 py-3 relative">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <p className="text-xs text-muted">
            No account?{" "}
            <Link href="/sign-up" className="font-medium text-foreground transition-colors hover:text-ochre">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <div className="w-full max-w-sm animate-fade-in-scale">
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center gap-2">
              ...
              <span className="text-micro text-ochre">Sign in</span>
            </div>
            <h1 className="text-headline text-foreground">Welcome back</h1>
            <p className="mt-2 text-body text-muted">Sign in to your vault</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              <div className="mb-1 flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-micro text-ochre transition-colors hover:text-ochre-dark">Forgot?</Link>
              </div>
              <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className="block w-full" placeholder="Enter password" />
            </div>
            <button type="submit" disabled={loading} className="brutal-button mt-3 w-full py-2.5 text-xs disabled:opacity-50 disabled:cursor-not-allowed">
              {loading ? (
          ...
          <p className="mt-6 text-center text-xs text-muted">
            No account?{" "}
            <Link href="/sign-up" className="font-semibold text-foreground transition-colors hover:text-ochre">Create one</Link>
          </p>
        </div>
      </main>
    </div>
